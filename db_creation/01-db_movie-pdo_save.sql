...
CREATE DATABASE IF NOT EXISTS `movie-pdo-01` /*!40100 DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_bin */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `movie-pdo-01`;

-- Listage de la structure de table movie-pdo-01. actor
...
-- Listage de la structure de table movie-pdo-01. casting
...
-- Listage de la structure de table movie-pdo-01. director
...
-- Listage de la structure de table movie-pdo-01. genre
CREATE TABLE IF NOT EXISTS `genre` (
  `id_genre` int NOT NULL AUTO_INCREMENT,
  `label` varchar(30) COLLATE utf8mb3_bin NOT NULL,
...
-- Listage de la structure de table movie-pdo-01. movie
CREATE TABLE IF NOT EXISTS `movie` (
  `id_movie` int NOT NULL AUTO_INCREMENT,
  `director_id` int NOT NULL,
  `title` varchar(30) COLLATE utf8mb3_bin NOT NULL,
  `duration` int NOT NULL,
  `release_date` date NOT NULL,
  `notation` decimal(2,1) DEFAULT NULL,
  `synopsis` text CHARACTER SET utf8mb3 COLLATE utf8mb3_bin,
  `poster` varchar(255) COLLATE utf8mb3_bin DEFAULT NULL,
...
INSERT INTO `movie` (`id_movie`, `director_id`, `title`, `duration`, `release_date`, `notation`, `synopsis`, `poster`) VALUES
	...
	(7, 7, 'Légende dautomne', 133, '1994-02-03', 8.3, 'Dans le Montana dans les années 1960, un vieil indien raconte les secrets de la famille Ludlow.', 'film7.jpg'),
...
-- Listage de la structure de table movie-pdo-01. movie_genre_link
...
-- Listage de la structure de table movie-pdo-01. role
...
-- Listage de la structure de table movie-pdo-01. staff
CREATE TABLE IF NOT EXISTS `staff` (
  ...
  `gender` varchar(50) COLLATE utf8mb3_bin DEFAULT NULL,
